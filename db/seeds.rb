...
flat_1 = Flat.create!(title: "Studio 30m2 Oberkampf", description: "Superbe
         ...
         date: DateTime.new(2017, 6, 1, 0, 0, 0, 0), price: 97500, average_price: 10500, size: 30,
         average_size: 45)
flat_2 = Flat.create!(title: "T3 de 60m2", description: "T3 très lumineux dans le 11ème arrondissement. Travaux à prévoir", address: "20 rue Parmentier, Paris",
         ...
         date: DateTime.new(2017, 7, 1, 0, 0, 0, 0), price: 100050, average_price: 10500, size: 60,
         average_size: 45)
flat_3 = Flat.create!(title: "Maison à Vincennes", description: "Superbe
         studio de 40m² situé à Oberkampf. Travaux à prévoir", address: "20 rue Oberkampf, Paris",
         floor: 4, rooms: 4, average_rooms: 3, bedrooms: 2, average_bedrooms: 1.4,
         date: DateTime.new(2017, 6, 1, 0, 0, 0, 0), price: 92050, average_price: 10500, size: 40,
         average_size: 45)
flat_4 = Flat.create!(title: "Studio 30m2 Oberkampf", description: "Superbe
         studio de 50m² situé à Oberkampf. Travaux à prévoir", address: "20 rue Oberkampf, Paris",
         floor: 4, rooms: 4, average_rooms: 3, bedrooms: 2, average_bedrooms: 1.4,
         date: DateTime.new(2017, 6, 1, 0, 0, 0, 0), price: 705990, average_price: 10500, size: 50,
         average_size: 45)
flat_5 = Flat.create!(title: "Studio 30m2 Oberkampf", description: "Superbe
         studio de 100m² situé à Oberkampf. Travaux à prévoir", address: "20 rue Oberkampf, Paris",
         floor: 4, rooms: 4, average_rooms: 3, bedrooms: 2, average_bedrooms: 1.4,
         date: DateTime.new(2017, 6, 1, 0, 0, 0, 0), price: 109750, average_price: 10500, size: 100,
         average_size: 45)
flat_6 = Flat.create!(title: "Studio 30m2 Oberkampf", description: "Superbe
         studio de 45m² situé à Oberkampf. Travaux à prévoir", address: "20 rue Oberkampf, Paris",
         floor: 4, rooms: 4, average_rooms: 3, bedrooms: 2, average_bedrooms: 1.4,
         date: DateTime.new(2017, 6, 1, 0, 0, 0, 0), price: 120000, average_price: 10500, size: 45,
         average_size: 45)
