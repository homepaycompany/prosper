...
# p "Creating wishes..."
# wish_1 = Wish.create(flat_url: , user: user_test_1)
# wish_2 = Wish.create(flat_url: , user: user_test_1)
# wish_3 = Wish.create(flat_url: , user: user_test_1)
# wish_4 = Wish.create(flat_url: , user: user_test_2)
# wish_5 = Wish.create(flat_url: , user: user_test_2)
